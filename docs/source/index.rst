...
SuperPandas is a lightweight Python package that enhances the popular Pandas library with AI-powered data analytics capabilities and SQL querying. It introduces a minimalistic wrapper using Pandas DataFrame `accessors <https://pandas.pydata.org/docs/development/extending.html>`_ to add custom super and sql namespaces, enabling metadata integration, SQL querying, and specialized methods designed for seamless interaction with large language models (LLMs).
...
* **SQL Query Accessor**: Execute SQL queries on pandas DataFrames using SQLite as the backend engine, supporting complex joins, aggregations, and data transformations.
